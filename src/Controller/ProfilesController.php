...
/////////////////////////////////////////////////////////////////////////////////////process order
        function cron($debugging = false) {
		
#$msg = "First line of text\nSecond line of text";
#$msg = wordwrap($msg,70);
#mail("info@trinoweb.com","My subject",$msg);
            ...
            $order = $orders
                ->find()
                ->where(['orders.draft' => 0])->order('orders.id DESC')->limit(2500);
            ...
            foreach ($order as $o) {
                ...
                if ($o->complete == 0  && $o->complete_writing == 1) {
                    ...
                    if ($complete == 1 && $o->complete == 0) {
                        ...
                        if ($profile1->email) {
							//debug( $profile1);
                             $path = $this->Manager->make_order_path($o);
							 $JSON = $this->Manager->order_to_email($o->id);

                             $this->Mailer->handleevent("cronordercomplete", array("site" => $setting->mee, "html" => $JSON, "path" => $path, "email" => array('super',$profile1->email)));
                        }
                    }
                }
            }
