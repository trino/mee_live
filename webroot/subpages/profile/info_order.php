...
/*
 ...
 echo '>';
    ...
    function printprovinces($name, $selected = "", $isdisabled = "disabled='disabled'", $isrequired = false){
        printoptions($name,getprovinces("Acronyms"), $selected, getprovinces(""), $isdisabled, $isrequired);
    }
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input <?php echo $is_disabled ?> name="email" id="driverEm" type="email"
                                                                      ...
                                                                      class="form-control  email" <?php if (isset($p->email)) { ?> value="<?php echo $p->email; ?>" <?php } ?>/>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <input <?php echo $is_disabled ?>  type="text"
                                                                           ...
                                                                           class="form-control req_driver " role="postalcode"
